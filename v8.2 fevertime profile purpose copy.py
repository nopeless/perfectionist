...
# v8.1
# changed deepcopy to try and reduce execution time
# and just got a 90% execution time reduce

# v8.2
# checking for additional timings
...
with profiler:
	main()
# Or to a file:
profiler.dump_stats("C:\public projects\perfectionist\profiler v8 out.txt")